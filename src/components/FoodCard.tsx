...
export default function FoodCard({ name, price, description, imageKey }: FoodCardProps) {
  ...
  return (
    <div className="group cursor-default">
      ...
      <div className="flex justify-between items-baseline mb-2">
        <h3 className="text-sm font-headline tracking-widest uppercase text-primary">{name}</h3>
